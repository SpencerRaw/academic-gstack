# ⚠️ Work in Progress — 构建中

> Academic GStack 正在活跃开发中。下面的设计文档描述了目标架构。
> 当前状态：方案设计阶段。P0 技能正在开发。
...
| `/document-release` — 文档更新 | `/paper-sync` — 论文与补充材料同步 |
...
| **Social Writer** | 自动生成 Twitter/X thread + LinkedIn + 中文解读 |
...
- [Science CEO 方法论](https://github.com/SpencerRaw/academic-gstack/tree/main/docs) — 科研人员从操作员到指挥家
